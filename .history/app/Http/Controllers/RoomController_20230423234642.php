...
class RoomController extends Controller
{
    ...
    public function all_Room(){
        ...
        $manager_Room=view('/phongchieu')->with('/phongchieu',$all_Room);
        return view('phongchieu')->with('all_Room',$all_Room);
    }
    ...
    public function delete_SuatChieu($IDPhongChieu){
