...
class SuatChieuController extends Controller
{
    public function add_SuatChieu(){
        return view('/admin.movieAddSuatChieu');
    }
    ...
    public function edit_SuatChieu($IDSuatChieu){
        ...
        $manager_User=view('/admin.suatchieu')->with('/admin.suatchieu',$edit_SuatChieu);
        return view('admin.suatchieu')->with('edit_SuatChieu',$edit_SuatChieu);
    }
