                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class=" form-group">
                        ...
                        <div class="product_count">
                            <input disabled type="text" name="qty" id="sst<?=$item['id']?>" maxlength="12"
                                value="<?=$item['num']?>" title="Quantity:" class="input-text qty">
                            <button onclick="update_cart(<?=$item['id']?>, 1)" class="increase items-count"
                                type="button"><i class="fa-solid fa-chevron-up"></i></button>
                            <button onclick="update_cart(<?=$item['id']?>, 0)" class="reduced items-count"
                                type="button"><i class="fa-solid fa-chevron-down"></i></button>
                        </div>
