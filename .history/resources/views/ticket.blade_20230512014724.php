        ...
        ?>
                    ...
                    <div class="movie-container">
                        ...
                        <div class="movieSeat container">
                            ...
                            <p class="text">
                                Bạn đang chọn <span id="count" name="count"></span> <input required="true"
                                    name="TenPhim" type="text" class="form-control" id="title" name="title"
                                    value="{{ $movie->TenPhim }} "> ghế với tổng giá.
